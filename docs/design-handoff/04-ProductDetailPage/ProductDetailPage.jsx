    ...
    <div className="bg-[#F8F9FA] min-h-screen pb-32 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-1/2 sticky top-24 self-start">
          <div className="relative aspect-square rounded-3xl overflow-hidden shadow-xl bg-white border-4 border-white flex items-center justify-center bg-orange-50">
          ...
          <div className="flex gap-4 mt-6 overflow-x-auto pb-2">
            <div className="w-20 h-20 flex-shrink-0 rounded-xl overflow-hidden border-2 border-green-500 shadow-md flex items-center justify-center bg-orange-50 text-2xl">🍎</div>
            <div className="w-20 h-20 flex-shrink-0 rounded-xl overflow-hidden border-2 border-transparent opacity-60 flex items-center justify-center bg-orange-50 text-2xl">🍎</div>
            <div className="w-20 h-20 flex-shrink-0 rounded-xl overflow-hidden border-2 border-transparent opacity-60 flex items-center justify-center bg-orange-50 text-2xl">🍎</div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex flex-wrap items-center gap-3 mb-4">
                ...
                <span className="bg-blue-50 text-blue-600 px-3 py-1 rounded-lg text-sm font-bold flex items-center gap-1">
                  <Truck size={14} /> 오늘출발
                </span>
              ...
              <div className="flex items-baseline gap-2 mb-6 border-b border-gray-100 pb-6">
                ...
                <span className="text-4xl font-black text-gray-900">32,000원</span>
                <span className="text-gray-400 line-through text-lg ml-2">37,600원</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3 text-gray-600 bg-gray-50 p-3 rounded-xl">
                  ...
                  <div>
                    ...
                    <div className="font-bold text-sm">국산 (경북 청송)</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 text-gray-600 bg-gray-50 p-3 rounded-xl">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 mt-6">
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 shadow-inner">
                  <div className="text-xs text-gray-500 mb-1 font-bold uppercase">포장단위</div>
                  <div className="font-bold text-gray-800">5kg (18-22과)</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 shadow-inner">
                  <div className="text-xs text-gray-500 mb-1 font-bold uppercase">생산자</div>
                  <div className="font-bold text-gray-800">청송사과조합</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 shadow-inner">
                  <div className="text-xs text-gray-500 mb-1 font-bold uppercase">보관방법</div>
                  <div className="font-bold text-gray-800">냉장보관</div>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-100 shadow-inner">
                  <div className="text-xs text-gray-500 mb-1 font-bold uppercase">등급</div>
                  <div className="font-bold text-gray-800">특 (1등급)</div>
                </div>
              </div>
      ...
      <div className="fixed bottom-6 left-4 right-4 md:left-1/2 md:-translate-x-1/2 md:w-[calc(100%-3rem)] max-w-7xl z-40">
        <div className="bg-white/90 backdrop-blur-xl border border-white/40 rounded-[2rem] p-2 pr-3 shadow-2xl flex items-center justify-between gap-4 pl-6 ring-1 ring-black/5">
          ...
          <div className="flex flex-col md:hidden">
            ...
            <span className="font-bold text-gray-900">32,000원</span>
          </div>

          <div className="flex items-center gap-3 flex-1 justify-end">
             <div className="text-right hidden md:block mr-4">
              <div className="text-xs text-gray-500 font-bold">총 결제금액</div>
              <div className="font-black text-2xl text-gray-900 leading-none">32,000원</div>
            </div>
